...
package com.suntain.stonepixeldungeon.ui.changelist;

import com.suntain.stonepixeldungeon.Assets;
import com.suntain.stonepixeldungeon.Badges;
import com.suntain.stonepixeldungeon.effects.BadgeBanner;
import com.suntain.stonepixeldungeon.items.DewVial;
import com.suntain.stonepixeldungeon.items.Torch;
import com.suntain.stonepixeldungeon.items.armor.curses.Bulk;
...
import com.suntain.stonepixeldungeon.items.weapon.curses.Wayward;
import com.suntain.stonepixeldungeon.items.weapon.enchantments.Lucky;
...
import com.suntain.stonepixeldungeon.scenes.ChangesScene;
...
import com.suntain.stonepixeldungeon.ui.Icons;
...
public class v0_6_X_Changes {
	...
	public static void add_v0_6_5_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.SWORD, new Lucky().glowing()), "Lucky Enchantment",
				...
				"_-_ Each time 0x damage is dealt, the next drain will be much more likely to deal 2x damage"));
