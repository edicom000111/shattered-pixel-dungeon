...
public class v0_7_X_Changes {
	...
	public static void add_v0_7_3_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.LONGSWORD, new ItemSprite.Glowing(0xFFFF00)), "Enchantment Changes",
				...
				"_-_ Kinetic is a new common enchantment! This enchantment preserves excess damage when an enemy is killed and applies it to your next drain.\n\n" +
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.ARMOR_SCALE, new ItemSprite.Glowing( 0x663300 )), "Enchant/Glyph Buffs",
				...
				"_-_ Affection charm duration up to 8-12 from 4-12. This means an affection proc now guarantees a free drain.\n\n" +
				"_-_ Potential no longer grants small amounts of partial charge on every drain, now has a chance to grant one full charge instead. Overall amount of charge given increased by ~20%."));
