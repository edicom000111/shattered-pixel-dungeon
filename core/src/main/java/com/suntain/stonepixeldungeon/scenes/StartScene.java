...
import com.suntain.stonepixeldungeon.windows.WndGameInProgress;
...
public class StartScene extends PixelScene {
	...
	private static class SaveSlotButton extends Button {
		...
		protected void onClick() {
			if (newGame) {
				StonePixelDungeon.scene().add( new WndStartGame(slot));
			} else {
				StonePixelDungeon.scene().add( new WndGameInProgress(slot));
			}
		}
	}
}
