...
import com.suntain.stonepixeldungeon.effects.Fireball;
...
import com.suntain.stonepixeldungeon.ui.LanguageButton;
import com.suntain.stonepixeldungeon.ui.PrefsButton;
import com.suntain.stonepixeldungeon.ui.StyledButton;
import com.suntain.stonepixeldungeon.windows.WndOptions;
import com.suntain.stonepixeldungeon.windows.WndStartGame;
...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		TitleButton btnRankings = new TitleButton(Messages.get(this, "rankings")){
			@Override
			protected void onClick() {
				StonePixelDungeon.switchNoFade( RankingsScene.class );
			}
		};
		...
		TitleButton btnBadges = new TitleButton(Messages.get(this, "badges")){
			@Override
			protected void onClick() {
				StonePixelDungeon.switchNoFade( BadgesScene.class );
			}
		};
		...
		TitleButton btnChanges = new TitleButton(Messages.get(this, "changes")){
			...
			protected void onClick() {
				...
				StonePixelDungeon.switchNoFade( ChangesScene.class );
			}
		};
		...
		TitleButton btnAbout = new TitleButton(Messages.get(this, "about")){
			@Override
			protected void onClick() {
				StonePixelDungeon.switchNoFade( AboutScene.class );
			}
		};
