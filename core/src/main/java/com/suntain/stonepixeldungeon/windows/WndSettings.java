...
import com.suntain.stonepixeldungeon.ui.CheckBox;
import com.suntain.stonepixeldungeon.ui.OptionSlider;
	...
	private class UITab extends Group {
		...
		public UITab(){
			...
			CheckBox chkFont = new CheckBox(Messages.get(this, "system_font")){
				...
				protected void onClick() {
					super.onClick();
					StonePixelDungeon.seamlessResetScene(new Game.SceneChangeCallback() {
						@Override
