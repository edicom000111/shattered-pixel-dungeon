...
import com.suntain.stonepixeldungeon.ui.ItemSlot;
...
public class WndBag extends WndTabbed {
	...
	private Image icon( Bag bag ) {
		...
		} else if (bag instanceof Deck) {
			return Icons.get( Icons.DECK );
		} else {
			...
			if (item != null) {
				...
				if (item.name() == null) {
					...
					enable(
						...
						mode == Mode.DECK && (item instanceof Card) ||
