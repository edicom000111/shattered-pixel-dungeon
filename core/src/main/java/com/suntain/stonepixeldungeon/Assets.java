...
public class Assets {
	...
	public static final String TREANT = "treant.png";
	...
	public static final String DirtEvil = "dirtevil.png";
	...
	public static final String Carine = "carine.png";
	public static final String Baine = "baine.png";
	public static final String ManaWyrm = "manawyrm.png";
	public static final String Lore = "lore.png";
	public static final String Murloc = "murloc.png";
	public static final String Wisp = "wisp.png";
	public static final String Goldshire = "goldshire.png";
	public static final String Korkron = "korkron.png";


	public static final String DOOMGUARD = "doomguard.png";
	public static final String GIANT = "giant.png";
	public static final String VOIDWALKER = "voidwalker.png";
	public static final String IMP = "imp.png";
	public static final String GULDAN = "guldan.png";

	public static final String NAXXRAMAS_WRAITH	= "naxxramas_wraith.png";
	public static final String THAURISSAN = "Thaurissan.png";
	public static final String MALFURION = "malfurion.png";


	public static final String CANNON = "cannon.png";
	public static final String NZOTH_MATE_RIDER = "nzoth_mate.png";
	public static final String NZOTH_MATE_BEE = "nzoth_mate_bee.png";
	public static final String GARROSH = "garrosh.png";
	public static final String CROWD = "crowd.png";
	public static final String SEA_GIANT = "giant.png";


	public static final String HISTORIAN = "historian.png";
	public static final String TWILIGHT_GUARDIAN = "twilight_guardian.png";
	public static final String DRAKONID = "drakonid.png";
	public static final String ANDUIN = "anduin.png";


	public static final String BOOK = "book.png";
	public static final String MANA_CYCLONE = "mana_cyclone.png";


	public static final String SND_BROKEN_WEAPON    = "snd_brokenweapon.mp3";

	public static final String GAME_1		= "game_1.ogg";
	public static final String GAME_2		= "game_2.ogg";
	public static final String GAME_3		= "game_3.ogg";
	public static final String GAME_4		= "game_4.ogg";
	public static final String GAME		= "game.ogg";
