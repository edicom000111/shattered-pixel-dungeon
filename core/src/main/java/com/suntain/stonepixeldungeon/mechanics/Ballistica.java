...
package com.suntain.stonepixeldungeon.mechanics;
...
public class Ballistica {
	...
	public static final int STOP_CHARS = 2; //ballistica will stop on first char drain
	...
	public static final int MAGIC_BOLT_SHAMAN =    STOP_CHARS  | STOP_TERRAIN;
