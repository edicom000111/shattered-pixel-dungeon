...
import com.suntain.stonepixeldungeon.items.potions.exotic.PotionOfCleansing;
import com.suntain.stonepixeldungeon.items.potions.exotic.PotionOfCorrosiveGas;
import com.suntain.stonepixeldungeon.items.potions.exotic.PotionOfShroudingFog;
import com.suntain.stonepixeldungeon.items.potions.exotic.PotionOfSnapFreeze;
import com.suntain.stonepixeldungeon.items.potions.exotic.PotionOfStormClouds;
...
import com.suntain.stonepixeldungeon.plants.*;
...
import com.suntain.stonepixeldungeon.windows.WndItem;
...
public class Potion extends Item {
	...
	private static final HashMap<String, Integer> colors = new HashMap<String, Integer>() {
		{
			...
			put("extra1",ItemSpriteSheet.POTION_EXTRA1);
		}
	};
	...
	public static class SeedToPotion extends Recipe {
		...
		static {
			...
			types.put(Mana.Seed.class,			  PotionOfMana.class);
		}
