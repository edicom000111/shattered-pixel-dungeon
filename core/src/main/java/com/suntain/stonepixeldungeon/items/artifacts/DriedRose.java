...
package com.suntain.stonepixeldungeon.items.artifacts;
...
import com.suntain.stonepixeldungeon.actors.blobs.CorrosiveGas;
...
import com.suntain.stonepixeldungeon.actors.mobs.npcs.NPC;
...
import com.suntain.stonepixeldungeon.windows.IconTitle;
import com.suntain.stonepixeldungeon.windows.WndBag;
import com.suntain.stonepixeldungeon.windows.WndBlacksmith;
...
public class DriedRose extends Artifact {
	...
	public static class GhostHero extends NPC {
		...
		public void sayAppeared(){
			...
			if (StonePixelDungeon.scene() instanceof GameScene) {
				Sample.INSTANCE.play( Assets.SND_GHOST );
			}
		}
