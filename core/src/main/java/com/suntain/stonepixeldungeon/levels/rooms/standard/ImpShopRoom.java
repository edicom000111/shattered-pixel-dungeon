...
package com.suntain.stonepixeldungeon.levels.rooms.standard;

import com.suntain.stonepixeldungeon.actors.mobs.Mob;
import com.suntain.stonepixeldungeon.actors.mobs.npcs.Demon;
import com.suntain.stonepixeldungeon.actors.mobs.npcs.ImpShopkeeper;
...
public class ImpShopRoom extends ShopRoom {
	...
	public void onLevelLoad(Level level) {
		...
		if (Demon.Quest.isCompleted() && !impSpawned){
			impSpawned = true;
			placeItems(level);
			placeShopkeeper(level);
		}
