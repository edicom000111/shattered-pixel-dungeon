...
import com.suntain.stonepixeldungeon.actors.mobs.npcs.Wandmaker;
...
import com.suntain.stonepixeldungeon.levels.*;
...
import com.suntain.stonepixeldungeon.utils.DungeonSeed;
...
public class Dungeon {
	...
	public static Level newLevel(int specialTarget) {
		Dungeon.level = null;
		Actor.clear();
		...
		level = new SpecialLevel(specialTarget);
	...
	public static void saveGame( int save ) throws IOException {
		try {
			...
			Demon.Quest.storeInBundle( quests );
	...
	public static void loadGame( int save, boolean fullLoad ) throws IOException {
		...
		if (fullLoad) {
			...
			if (!quests.isNull()) {
				...
				Demon.Quest.restoreFromBundle( quests );
			} else {
				Ghost.Quest.reset();
				Wandmaker.Quest.reset();
				Blacksmith.Quest.reset();
