...
import com.suntain.stonepixeldungeon.actors.mobs.*;
...
import com.suntain.stonepixeldungeon.items.armor.*;
...
import com.suntain.stonepixeldungeon.levels.SewerLevel;
import com.suntain.stonepixeldungeon.messages.Messages;
import com.suntain.stonepixeldungeon.scenes.GameScene;
import com.suntain.stonepixeldungeon.sprites.GhostSprite;
import com.suntain.stonepixeldungeon.utils.GLog;
import com.suntain.stonepixeldungeon.windows.WndQuest;
import com.suntain.stonepixeldungeon.windows.WndSadGhost;
...
public class Ghost extends NPC {
	...
	public boolean interact() {
		...
		if (Quest.given) {
			if (Quest.weapon != null) {
				if (Quest.processed) {
					...
					switch (Quest.type) {
						case 1:
						default:
							GameScene.show(new WndQuest(this, Messages.get(this, "murloc_2")));
							break;
						case 2:
							GameScene.show(new WndQuest(this, Messages.get(this, "imp_2")));
							break;
						case 3:
							GameScene.show(new WndQuest(this, Messages.get(this, "giant_2")));
							break;
					}
			...
			switch (Quest.type){
				case 1: default:
					questBoss = new Murloc();
					txt_quest = Messages.get(this, "murloc_1", Dungeon.hero.givenName()); break;
				case 2:
					questBoss = new ImpGangBoss();
					txt_quest = Messages.get(this, "imp_1", Dungeon.hero.givenName()); break;
				case 3:
					questBoss = new SeaGiant();
					txt_quest = Messages.get(this, "giant_1", Dungeon.hero.givenName()); break;
			}
