...
import com.suntain.stonepixeldungeon.actors.blobs.Alchemy;
import com.suntain.stonepixeldungeon.actors.buffs.AdrenalineSurge;
import com.suntain.stonepixeldungeon.actors.buffs.Amok;
import com.suntain.stonepixeldungeon.actors.buffs.Awareness;
import com.suntain.stonepixeldungeon.actors.buffs.Barkskin;
import com.suntain.stonepixeldungeon.actors.buffs.Berserk;
import com.suntain.stonepixeldungeon.actors.buffs.Bless;
import com.suntain.stonepixeldungeon.actors.buffs.Buff;
import com.suntain.stonepixeldungeon.actors.buffs.Burning;
import com.suntain.stonepixeldungeon.actors.buffs.Combo;
import com.suntain.stonepixeldungeon.actors.buffs.Drowsy;
import com.suntain.stonepixeldungeon.actors.buffs.FlavourBuff;
import com.suntain.stonepixeldungeon.actors.buffs.Foresight;
import com.suntain.stonepixeldungeon.actors.buffs.Fury;
import com.suntain.stonepixeldungeon.actors.buffs.Hunger;
import com.suntain.stonepixeldungeon.actors.buffs.Invisibility;
import com.suntain.stonepixeldungeon.actors.buffs.MindVision;
import com.suntain.stonepixeldungeon.actors.buffs.Momentum;
import com.suntain.stonepixeldungeon.actors.buffs.Paralysis;
import com.suntain.stonepixeldungeon.actors.buffs.Regeneration;
import com.suntain.stonepixeldungeon.actors.buffs.SnipersMark;
...
import com.suntain.stonepixeldungeon.items.Amulet;
...
import com.suntain.stonepixeldungeon.items.Heap.Type;
...
import com.suntain.stonepixeldungeon.items.armor.glyphs.Viscosity;
...
import com.suntain.stonepixeldungeon.items.keys.CrystalKey;
import com.suntain.stonepixeldungeon.items.keys.GoldenKey;
import com.suntain.stonepixeldungeon.items.keys.IronKey;
import com.suntain.stonepixeldungeon.items.keys.Key;
...
import com.suntain.stonepixeldungeon.items.weapon.enchantments.Blocking;
...
import com.suntain.stonepixeldungeon.journal.Notes;
...
import com.suntain.stonepixeldungeon.scenes.AlchemyScene;
import com.suntain.stonepixeldungeon.scenes.GameScene;
import com.suntain.stonepixeldungeon.scenes.InterlevelScene;
import com.suntain.stonepixeldungeon.scenes.SurfaceScene;
...
import com.suntain.stonepixeldungeon.windows.WndResurrect;
...
public class Hero extends Char {
	...
	public static void preview( GamesInProgress.Info info, Bundle bundle ) {
		...
		info.mp = bundle.getInt( Char.TAG_MP );
		info.mt = bundle.getInt( Char.TAG_MT );
	...
	public boolean act() {
		...
		if (curAction == null) {
			...
			if (curAction instanceof HeroAction.Maze) {

				return actMaze( (HeroAction.Maze)curAction );
	...
	private boolean actAlchemy( HeroAction.Alchemy action ) {
		...
		if (Dungeon.level.distance(dst, pos) <= 1) {
			...
			StonePixelDungeon.switchScene(AlchemyScene.class);
			return false;
	...
	private boolean actMaze( HeroAction.Maze action ) {
		int stairs = action.dst;

		if (pos == stairs && pos == Dungeon.level.specialEntrance) {
			...
			InterlevelScene.mode = InterlevelScene.Mode.MAZE;
			Game.switchScene( InterlevelScene.class );
	...
	public boolean handle( int cell ) {
		...
		} else if (cell == Dungeon.level.specialEntrance){

			curAction = new HeroAction.Maze(cell);
		} else  {
