...
import com.suntain.stonepixeldungeon.items.quest.CorpseDust;
import com.suntain.stonepixeldungeon.items.quest.Embers;
...
import com.suntain.stonepixeldungeon.levels.rooms.special.MassGraveRoom;
import com.suntain.stonepixeldungeon.levels.rooms.standard.RitualSiteRoom;
import com.suntain.stonepixeldungeon.messages.Messages;
import com.suntain.stonepixeldungeon.scenes.GameScene;
import com.suntain.stonepixeldungeon.sprites.WandmakerSprite;
import com.suntain.stonepixeldungeon.windows.WndQuest;
import com.suntain.stonepixeldungeon.windows.WndWandmaker;
		...
		if (Quest.given) {
			...
			switch (Quest.type) {
				...
				case 2:
					...
					break;
				case 3:
					item = Dungeon.hero.belongings.getItem(CeremonialCandle.class);
					break;
			}
