...
import com.suntain.stonepixeldungeon.sprites.CrowdSprite;
import com.suntain.stonepixeldungeon.sprites.SheepSprite;
import com.suntain.stonepixeldungeon.utils.GLog;
import com.watabou.utils.Bundle;
import com.watabou.utils.Random;

public class Crowd extends NPC {

	public int type;
	{
		spriteClass = CrowdSprite.class;
	}
	...
	protected boolean act() {
		spend(TICK);
		if(((PrisonBossLevel)Dungeon.level).boss == null || !((PrisonBossLevel)Dungeon.level).boss.isAlive()){
			HP = 0;
			destroy();
			sprite.die();
		}
