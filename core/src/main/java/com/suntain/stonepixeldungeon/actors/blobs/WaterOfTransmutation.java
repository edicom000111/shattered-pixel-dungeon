...
import com.suntain.stonepixeldungeon.items.Generator.Category;
...
private Card changeCard( Card c ) {

		Card n;

		do {
			n = (Card)Generator.random( Category.CARD );
		} while (n.getClass() == c.getClass());
