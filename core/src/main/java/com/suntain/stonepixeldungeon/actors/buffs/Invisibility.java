...
public class Invisibility extends FlavourBuff {
	...
	public static void dispel() { //public static void dispel(Char c) {
	...
	public static void dispel(Char target) {
		Invisibility buff = target.buff( Invisibility.class );
		if (buff != null) {
			buff.detach();
		}
		CloakOfShadows.cloakStealth cloakBuff = target.buff( CloakOfShadows.cloakStealth.class );
		if (cloakBuff != null) {
			cloakBuff.dispel();
		}
		//this isn't a form of invisibilty, but it is meant to dispel at the same time as it.
		TimekeepersHourglass.timeFreeze timeFreeze = target.buff( TimekeepersHourglass.timeFreeze.class );
		if (timeFreeze != null) {
			timeFreeze.detach();
		}
	}
