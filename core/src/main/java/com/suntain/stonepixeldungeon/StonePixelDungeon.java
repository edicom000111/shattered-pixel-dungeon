...
import com.suntain.stonepixeldungeon.scenes.WelcomeScene;
...
public class StonePixelDungeon extends Game {
	...
	public StonePixelDungeon() {
		...
		com.watabou.utils.Bundle.addAlias(
				com.suntain.stonepixeldungeon.items.weapon.enchantments.Grim.class,
				"com.shatteredpixel.shatteredpixeldungeon.items.weapon.enchantments.Stunning" );
		com.watabou.utils.Bundle.addAlias(
				com.suntain.stonepixeldungeon.items.weapon.enchantments.Chilling.class,
				"com.shatteredpixel.shatteredpixeldungeon.items.weapon.enchantments.Venomous" );
		com.watabou.utils.Bundle.addAlias(
				com.suntain.stonepixeldungeon.items.weapon.enchantments.Kinetic.class,
