...
package com.suntain.stonepixeldungeon.messages;

import com.suntain.stonepixeldungeon.SPDSettings;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.suntain.stonepixeldungeon.messages.actors.actors",
			"com.suntain.stonepixeldungeon.messages.items.items",
			"com.suntain.stonepixeldungeon.messages.journal.journal",
			"com.suntain.stonepixeldungeon.messages.levels.levels",
			"com.suntain.stonepixeldungeon.messages.plants.plants",
			"com.suntain.stonepixeldungeon.messages.scenes.scenes",
			"com.suntain.stonepixeldungeon.messages.ui.ui",
			"com.suntain.stonepixeldungeon.messages.windows.windows",
			"com.suntain.stonepixeldungeon.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.suntain.stonepixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
		...
		if (strings.containsKey(key.toLowerCase(Locale.ENGLISH))){
			...
			if (c != null && c.getSuperclass() != null){
				...
				return "ERROR - "+key.replace("java.lang.Object.", "")+"\n";
			}
		}
	}
