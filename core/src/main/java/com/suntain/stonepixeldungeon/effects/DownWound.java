...
public class DownWound extends Image {
	...
	public void reset( int p ) {
		...
		y = (p / Dungeon.level.width()) * DungeonTilemap.SIZE + (DungeonTilemap.SIZE - height) / 2 + DungeonTilemap.SIZE / 2;
	...
	public static void hit( Char ch, float angle ) {
		if (ch.sprite.parent != null) {
			DownWound w = (DownWound) ch.sprite.parent.recycle(DownWound.class);
	...
	public static void hit( int pos, float angle ) {
		...
		DownWound w = (DownWound)parent.recycle( DownWound.class );
