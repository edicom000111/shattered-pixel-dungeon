...
import com.suntain.stonepixeldungeon.effects.DarkBlock;
import com.suntain.stonepixeldungeon.effects.EmoIcon;
import com.suntain.stonepixeldungeon.effects.FloatingText;
import com.suntain.stonepixeldungeon.effects.IceBlock;
import com.suntain.stonepixeldungeon.effects.ShieldHalo;
import com.suntain.stonepixeldungeon.effects.Speck;
import com.suntain.stonepixeldungeon.effects.Splash;
import com.suntain.stonepixeldungeon.effects.TorchHalo;
...
import com.suntain.stonepixeldungeon.effects.particles.SnowParticle;
...
public class CharSprite extends MovieClip implements Tweener.Listener, MovieClip.Listener {
	...
	public void showBub() {
		if (ch.BUB && ch.isAlive()) {
			if (Bub != null) {
				Bub.killAndErase();
			}
			Bub = new EmoIcon.Bub( this );
			Bub.visible = visible;
		} else Bub.killAndErase();
		//idle();
	}
	...
	public synchronized void update() {
		...
		if(Bub != null || (ch != null && ch.isAlive() && ch.BUB)) showBub();
		if (burning != null) {
