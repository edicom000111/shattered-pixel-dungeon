...
public class ItemSpriteSheet {
	...
	public static final int POTION_EXTRA1    = POTIONS+12;
	...
	public static final int SEED_EXTRA1 = SEEDS+12;
	static{
	...
	private static final int BAGS       =                                   xy(1, 30);  //16 slots
	...
	public static final int DECK       = BAGS+5;
	static{
		...
		assignItemRect(DECK,     16, 16);
	}
	private static final int CARDS       =                                   xy(1, 31);  //16 slots
	public static final int WARRIOR_ABILITY        = CARDS+0;
	public static final int SHAMAN_ABILITY       = CARDS+1;
	public static final int ROGUE_ABILITY      = CARDS+2;
	public static final int HUNTER_ABILITY   = CARDS+3;
	public static final int ANCESTRAL_HEALING   = CARDS+4;
	public static final int TIDAL_SURGE   = CARDS+5;
	public static final int BLADE_FLURRY   = CARDS+6;
	public static final int SHIELD_SLAM   = CARDS+7;
	public static final int LAZA   = CARDS+8;
	public static final int INNER_RAGE   = CARDS+9;

	static{
		assignItemRect(WARRIOR_ABILITY,        16, 16);
		assignItemRect(SHAMAN_ABILITY,       16, 16);
		assignItemRect(ROGUE_ABILITY,      16, 16);
		assignItemRect(HUNTER_ABILITY,   16, 16);
		assignItemRect(ANCESTRAL_HEALING,        16, 16);
		assignItemRect(TIDAL_SURGE,       16, 16);
		assignItemRect(BLADE_FLURRY,      16, 16);
		assignItemRect(LAZA,      16, 16);
		assignItemRect(SHIELD_SLAM,      16, 16);
	}
