...
public class HeroSprite extends CharSprite {
	...
	public void showQuest() {
		if (Dungeon.level.QUEST > 0) {
			if (Quest != null) {
				Quest.killAndErase();
			}
			Quest = new EmoIcon.Quest( this );
			Quest.visible = visible;
		} else Quest.killAndErase();
		//idle();
	}
	...
	public void update() {
		...
		if(Quest != null || (ch != null && ch.isAlive() && Dungeon.level.QUEST > 0)) showQuest();
		super.update();
	}
